...
2. I am having an issue with the last part of the program where the UnionFindStructure thinks there is only one set, but there are still vertices of degree 0. This doesn't happen every time.
